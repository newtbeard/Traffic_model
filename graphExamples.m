...
wgPlot(tripff,nodePos,'vertexWeight',pops,'vertexMetaData',attr,'edgeWidth',2,'edgeColorMap',jet,'vertexColorMap',cool);
figure(4)
title('Decaying Exponenetial Trip Distribution')
wgPlot(tripfe,nodePos,'vertexWeight',pops,'vertexMetaData',attr,'edgeWidth',2,'edgeColorMap',jet,'vertexColorMap',cool);